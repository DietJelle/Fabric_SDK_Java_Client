...
public class BlockchainNetworkAttributes {
    ...
    public static final String ORG1_DEPARTMENT1 = "org1.department1";
    ...
    public static final String CHAINCODE_1_NAME = "MerkeChaincodeJava";

    public static final String CHAINCODE_1_VERSION = "0.1";
